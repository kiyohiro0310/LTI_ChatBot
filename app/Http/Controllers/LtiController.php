...
class LtiController extends Controller
{
    ...
    public function ltiMessage(Request $request)
    {
        ...
        // $tool->handleRequest();
        $url = 'https://ol-chat-bot.vercel.app/api/lti?id='.$request->lis_person_sourcedid.'&name='.$request->lis_person_name_full;
        ...
        */
        ...
        // $request->session()->put('lti_message_type', $tool->rleti_message_type?->getRecordId());
